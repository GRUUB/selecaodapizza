...
<head>
  <title>Esqueceu sua senha - Seleção da Pizza</title>
...
<div class="account-wrapper">
  ...
  <div class="account-logo">
    <img src="https://gruub.com.br/selecaodapizza/img/logo-login.png" alt="Target Admin">
  </div>

    <div class="account-body">

      <h3 class="account-body-title">Resetar a senha</h3>

      <h5 class="account-body-subtitle">Vamos enviar no seu e-mail instruções sobre como redefinir sua senha.</h5>

      <form class="form account-form" method="POST" action="">

        <div class="form-group">
          <label for="forgot-email" class="placeholder-hidden">Seu E-mail</label>
          <input type="text" class="form-control" id="forgot-email" name="email" placeholder="Seu E-mail" tabindex="1">
        </div> <!-- /.form-group -->

        <div class="form-group">
          <button type="submit" class="btn btn-secondary btn-block btn-lg" tabindex="2">
            Trocar a senha &nbsp; <i class="fa fa-refresh"></i>
          </button>
        </div> <!-- /.form-group -->

        <div class="form-group">
          <a href="https://gruub.com.br/selecaodapizza/account-login.php"><i class="fa fa-angle-double-left"></i> &nbsp;Volte ao login</a>
        </div> <!-- /.form-group -->
